        ...
        <section className="mx-auto max-w-5xl px-6 py-16">
          <div className="rounded-[2rem] border border-zinc-800 bg-black p-8">
            ...
            <p className="mt-3 text-zinc-500">
              Rode o seed novamente para criar o negócio demo.
            </p>
          </div>
        </section>
      </main>
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-zinc-400">
                Acompanhe os clientes, serviços, horários e estados das
                marcações recebidas.
              </p>
            </div>
                ...
                {filterLinks.map((filter) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={
                          isActive ? "text-zinc-600" : "text-zinc-600"
                        }
                      >
                        ({filter.count})
                      </span>
                          ...
                          <div className="mt-4 grid gap-2">
                            {booking.status !== "COMPLETED" && (
                              <form action={updateBookingStatusAction}>
                                ...
                                <button
                                  type="submit"
                                  className="w-full rounded-2xl border border-zinc-700 px-4 py-3 text-sm font-semibold text-zinc-300 transition hover:border-white hover:text-white"
                                >
                            ...
                            {booking.status !== "CONFIRMED" && (
                              <form action={updateBookingStatusAction}>
                                ...
                                <button
                                  type="submit"
                                  className="w-full rounded-2xl border border-white bg-white px-4 py-3 text-sm font-semibold text-zinc-950 transition hover:bg-zinc-200"
                                >
