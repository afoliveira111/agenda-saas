...
import { createBusinessAction, selectBusinessAction } from "./actions"
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="rounded-[2rem] border border-zinc-800 bg-gradient-to-br from-zinc-900 via-zinc-950 to-black p-8 shadow-2xl">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-zinc-400">
                Cadastre e visualize os espaços, clínicas ou salões que usarão o
                sistema. Esta etapa prepara a base para multi-negócio.
              </p>
            </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-3xl border border-zinc-800 bg-black/40 p-5">
              <p className="text-sm text-zinc-500">Modo atual</p>
              <p className="mt-2 text-lg font-semibold">
                Seletor local sem login
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[420px_1fr]">
          <div className="rounded-[2rem] border border-zinc-800 bg-black p-6 shadow-2xl">
            ...
            <p className="mt-3 text-sm text-zinc-500">
              Crie um segundo espaço para testar links públicos diferentes, como
              /book/clinica-teste.
            </p>
          ...
          <div className="rounded-[2rem] border border-zinc-800 bg-zinc-950 p-4 shadow-2xl">
            <div className="border-b border-zinc-800 px-2 pb-4">
              ...
              <p className="mt-2 text-sm text-zinc-500">
                Por enquanto este seletor fica salvo apenas neste navegador.
                Depois, com login, cada utilizador verá apenas o próprio negócio.
              </p>
            </div>
